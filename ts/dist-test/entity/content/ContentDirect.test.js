...
(0, node_test_1.describe)('ContentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-content', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-content', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.TVP_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'TVP_TEST_CONTENT_ENTID': {},
        'TVP_TEST_LIVE': 'FALSE',
    });
    ...
    if (live) {
        ...
        const client = new __1.TvpSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['TVP_TEST_CONTENT_ENTID'];
...
//# sourceMappingURL=ContentDirect.test.js.map