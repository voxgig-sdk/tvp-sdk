...
The TypeScript SDK for the Tvp API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Content()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `TvpSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `TvpSDK.test(testopts?, sdkopts?)` | `TvpSDK` | Create a test-mode client. |
...
| `client` | `client(): TvpSDK` | Return the parent SDK client. |
