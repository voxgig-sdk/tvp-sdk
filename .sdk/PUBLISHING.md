...
|---|---|---|
| `ts/` | @voxgig-sdk/tvp-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/tvp-sdk \
      --repository voxgig-sdk/tvp-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/tvp-sdk` shows it, and
`npm trust revoke @voxgig-sdk/tvp-sdk --id=<id>` removes it.
