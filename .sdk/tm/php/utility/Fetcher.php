...
class TvpFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TvpSDK/1.0)';
    ...
    public static function call(TvpContext $ctx, string $fullurl, array $fetchdef): array
    {
