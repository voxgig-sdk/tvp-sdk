...
class TvpCacheFeature extends TvpBaseFeature
{
    ...
    private function _through(TvpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
