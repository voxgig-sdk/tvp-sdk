...
class TvpRbacFeature extends TvpBaseFeature
{
    ...
    private function _required(TvpContext $ctx): ?string
    {
    ...
    private function _reject(TvpContext $ctx, string $required): void
    {
    ...
    private function _track(TvpContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
