...
class TvpRatelimitFeature extends TvpBaseFeature
{
    ...
    private function _acquire(TvpContext $ctx): void
    {
    ...
    private function _track(TvpContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
