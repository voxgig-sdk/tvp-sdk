...
TvpSDK._make_feature = _make_feature


function TvpSDK.new(options)
  local self = setmetatable({}, TvpSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function TvpSDK:get_utility()
  return Utility.copy(self._utility)
end


function TvpSDK:get_root_ctx()
  return self._rootctx
end


function TvpSDK:prepare(fetchargs)
...
function TvpSDK:direct(fetchargs)
...
-- by passing it.
function TvpSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function TvpSDK:graphql(query, variables, ctrl)
...
function TvpSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
