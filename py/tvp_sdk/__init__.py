...
from tvp_sdk.utility import register

# Load features
from tvp_sdk.feature.base_feature import TvpBaseFeature
from tvp_sdk.features import _has_feature, _make_feature
...
class TvpSDK:
    ...
    def __init__(self, options=None):
        ...
        from tvp_sdk.config import shared_config
    ...
    def get_utility(self):
        return TvpUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TvpSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Content(self, data=None) -> "ContentEntity":
        ...
        from tvp_sdk.entity.content_entity import ContentEntity
        return ContentEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "TvpSDK":
        if sdkopts is None:
            sdkopts = {}
