# Tvp SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TvpSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TvpSDK(...) and TvpSDK.test(...) become
#      TvpSDK.test({"entity": {...}}) seeding one mock record (id "test01")
