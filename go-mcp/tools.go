...
type Args struct {
	Entity string         `json:"entity" jsonschema:"content"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TvpSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "tvp_list",
		Description: "List records from Tvp. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "tvp_load",
		Description: "Load a single record from Tvp. " +
...
func runOp(client *sdk.TvpSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TvpSDK, name string) (sdk.TvpEntity, error) {
