...
// Tvp SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TvpSDK::test)
...
{
    private const SDK_CLASS = 'TvpSDK';
    ...
    private const SDK_BASE = 'tvp_sdk';
