...
{
    private static function utility(): TvpUtility
    {
        return new TvpUtility();
    }
    ...
    private static function ctx(array $over = []): TvpContext
    {
        ...
        $ctx->op = new TvpOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TvpError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TvpOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TvpMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TvpOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TvpMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TvpOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TvpMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TvpSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TvpMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TvpResponse([]),
            'result' => new TvpResult([]),
        ]);
        [, $err] = TvpMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TvpSpec(['step' => 's']),
            'response' => new TvpResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TvpResult([]),
        ]);
        [, $err] = TvpMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TvpSpec(['step' => 's']),
            'response' => new TvpResponse(self::resp(200, ['v' => 1])),
            'result' => new TvpResult([]),
        ]);
        [, $err] = TvpMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TvpSpec(['step' => 's']),
            'response' => new TvpResponse(self::resp(200, ['v' => 2])),
            'result' => new TvpResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TvpMakeResponse::call($ctx);
    ...
    {
        $preset = new TvpResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TvpSpec([]),
            'response' => new TvpResponse([]),
            'result' => new TvpResult([]),
        ...
        [$got, $err] = TvpMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TvpResult([])]);
        [, $err] = TvpMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TvpSpec([]), 'result' => null]);
        [, $err] = TvpMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TvpSpec(['step' => 's']),
            'result' => new TvpResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TvpOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TvpMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TvpSpec(['step' => 's']),
            'result' => new TvpResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TvpOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TvpMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TvpResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TvpSpec([]),
            'result' => new TvpResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TvpMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $utility = self::utility();
        $boom = new TvpError('boom', 'boom');
        $utility->fetcher = function (TvpContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TvpSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TvpMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TvpContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TvpMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TvpResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TvpContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TvpSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TvpMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TvpResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TvpSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TvpMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TvpMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TvpResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TvpDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TvpResult(['ok' => false])]);
        $this->expectException(TvpError::class);
        TvpDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TvpResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TvpMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TvpBaseFeature();
        $b = new TvpBaseFeature();
        TvpFeatureAdd::call($ctx, $a);
        TvpFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TvpBaseFeature
    {
        $f = new TvpBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    private static function auth_ctx(array $options, ?array $headers): TvpContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new TvpSpec(['headers' => $headers]),
        ]);
    }
    ...
    {
        $ctx = self::ctx([
            'response' => new TvpResponse(['headers' => null]),
            'result' => new TvpResult([]),
        ]);
        TvpResultHeaders::call($ctx);
