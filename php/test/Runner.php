...
class TvpTestRunner
{
    ...
    {
        $live = self::getenv('TVP_TEST_LIVE');
        $override = self::getenv('TVP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TVP_TEST_EXPLAIN');
...
class_alias('TvpTestRunner', 'Runner');
class_alias('TvpHelpers', 'Helpers');
