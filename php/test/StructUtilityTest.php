...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TvpOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TvpOmni::structfix($now, Struct::undef()))
                        !== json_encode(TvpOmni::structfix($val, Struct::undef()))) {
