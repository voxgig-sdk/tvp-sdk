...
class TvpTimeoutFeature extends TvpBaseFeature
{
    ...
    private function _with_timeout(TvpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TvpContext $_ctx, float $ms): void
    {
        $client = $this->client;
