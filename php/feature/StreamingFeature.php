...
class TvpStreamingFeature extends TvpBaseFeature
{
    ...
    private function _iterate(TvpResult $result): \Generator
    {
    ...
    private function _streamable(TvpContext $ctx): bool
    {
