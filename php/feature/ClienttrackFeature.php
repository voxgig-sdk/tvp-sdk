...
class TvpClienttrackFeature extends TvpBaseFeature
{
    ...
    public function PostConstruct(TvpContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Tvp-SDK';
