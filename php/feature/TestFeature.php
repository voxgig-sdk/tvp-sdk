...
// Tvp SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TvpTestFeature extends TvpBaseFeature
{
    ...
    public function init(TvpContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TvpContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TvpContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TvpContext $ctx, $op, $args): array
    {
