...
func (sdk *TvpSDK) OptionsMap() map[string]any {
...
func (sdk *TvpSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TvpSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TvpSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TvpSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TvpSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TvpSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TvpSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TvpSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TvpSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TvpSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *TvpSDK) Content(data map[string]any) TvpEntity {
