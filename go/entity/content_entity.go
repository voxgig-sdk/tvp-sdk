...
import (
	...
	vs "github.com/voxgig-sdk/tvp-sdk/go/utility/struct"
)
...
func NewContentEntity(client *core.TvpSDK, entopts map[string]any) *ContentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContentEntity) GetName() string { return e.name }
...
func (e *ContentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContentEntity) Deleted() bool {
	return e.deleted
}


func (e *ContentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContentEntity(e.client, opts)
}

func (e *ContentEntity) Data(args ...any) any {
...
func (e *ContentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Content; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContentEntity) DataTyped(data ...Content) Content {
	if len(data) > 0 {
		return typedFrom[Content](e.Data(asMap(data[0])))
	}
	return typedFrom[Content](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Content (all fields
// optional at the wire level).
func (e *ContentEntity) MatchTyped(match ...Content) Content {
	if len(match) > 0 {
		return typedFrom[Content](e.Match(asMap(match[0])))
	}
	return typedFrom[Content](e.Match())
}
...
func (e *ContentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContentLoadMatch and returns an Content. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ContentEntity) LoadTyped(reqmatch ContentLoadMatch, ctrl map[string]any) (Content, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Content{}, err
	}
	return typedFrom[Content](res), nil
}



func (e *ContentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ContentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ContentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
