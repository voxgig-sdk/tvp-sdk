...
module TvpTestRunner
  ...
  def self.env_override(m)
    live = getenv("TVP_TEST_LIVE")
    override = getenv("TVP_TEST_OVERRIDE")
    ...
    explain = getenv("TVP_TEST_EXPLAIN")
    m["TVP_TEST_EXPLAIN"] = explain if explain && !explain.empty?
